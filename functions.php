...
function wpc_theme_js() {
	...
	wp_enqueue_script('function_js', get_template_directory_uri().'/js/function.js', '', '', false);
	wp_enqueue_script('slick_js', get_template_directory_uri().'/js/slick.min.js', '', '', false);
	wp_enqueue_script('imageMapResizer_js', get_template_directory_uri().'/js/imageMapResizer.min.js', '', '', false);
	wp_enqueue_script('uitotop_js', get_template_directory_uri().'/js/jquery.uitotop.js', '', '', false);
	wp_enqueue_script('uploadify_js', get_template_directory_uri().'/js/jquery.uploadify.js', '', '', false);
	//wp_enqueue_script('blockUI_js', get_template_directory_uri().'/js/jquery.blockUI.js', array('jquery'), '', false);
